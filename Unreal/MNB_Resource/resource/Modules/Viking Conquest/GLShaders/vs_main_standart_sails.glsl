...
void main()
{
	...
	VSOut = vs_main_standart_sails(CURRENT_PCF_MODE, true, false, vec4(inPosition, 1.0), inNormal, inTexCoord, inTangent, inBinormal, inColor0, inBlendWeight, inBlendIndices);
