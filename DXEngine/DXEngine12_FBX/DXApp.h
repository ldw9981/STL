...
protected:
	...
	XMFLOAT2 ReadUV(FbxMesh* mesh, int controlPoint, int vertexCounter);
	XMFLOAT3 ReadNormal(FbxMesh* mesh, int controlPoint, int vertexCounter);
};