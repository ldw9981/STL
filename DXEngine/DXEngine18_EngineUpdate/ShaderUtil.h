...
namespace ShaderUtil
{
	...
	// 버텍스 쉐이더 바인딩
	void BindVertexShader(ID3D11DeviceContext* deviceContext, ID3D11VertexShader* pVertexShader,ID3D11ClassInstance * const * ppClassInstances,UINT NumClassInstances);
	...
	// 픽셀 쉐이더 바인딩
	void BindPixelShader(ID3D11DeviceContext* deviceContext,ID3D11PixelShader *pPixelShader,ID3D11ClassInstance *const *ppClassInstances,
